...
2. If arr[mid] <= arr[right], pivot is at left <= pivot <= mid, search to the left.
3. If arr[mid] > arr[right], pivot is at mid < pivot <= right, search to the right.

### Code
Credit: https://leetcode.com/problems/find-minimum-in-rotated-sorted-array/discuss/158940/Beat-100%3A-Very-Simple-(Python)-Very-Detailed-Explanation
